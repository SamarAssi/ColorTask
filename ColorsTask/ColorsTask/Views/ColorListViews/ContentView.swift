...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            colorViewModel.colors = UserDefaultsManager().loadColors()
            colorViewModel.setDefaultColorValues()
        }
        .onChange(of: colorViewModel.colors) {
            colorViewModel.updateColorValuesBasedOnChanges()
        }
    }
}
...
extension ContentView {
    var portraitMode: some View {
        ...
        .background(colorViewModel.background)
    }
